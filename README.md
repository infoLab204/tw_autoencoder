...
To loading data set, run load_data.py with following parameters.
  ...
  * output  : result of storing MNIST, FMNIST, SHVN, or CIFAR-10 datasets and their labels in 10,000 parts
  ...
  ```
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(eg) MNIST_X_data_1.csv : data set of MNIST   
...
To evaluate the loss function for all models and each class, simply run loss.R with the values of units in the output lapyer of each model.    
  ...
  ```
  * data type : data type, select data set from MNIST, FMNIST, SVHN or CIFAR-10
  ...
  * output  : mean squred error of all models and each class label
  ...
  ```
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(eg) MNIST_total_loss_4.csv : mean squred error of all models      
